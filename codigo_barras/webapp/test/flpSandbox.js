		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#codigobarras-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"codigobarras-display": {
								"semanticObject": "codigobarras",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=codigobarras",
									"url": sap.ui.require.toUrl("codigobarras")
								}
							}
						}
					}
